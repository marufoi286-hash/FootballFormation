        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matche_Team_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Team",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matche_Venue_VenueId",
                        column: x => x.VenueId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PitchData = table.Column<List<PitchPlayer>>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Formation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Formation_Matche_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Formation_MatchId",
                table: "Formation",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_Matche_TeamId",
                table: "Matche",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Matche_VenueId",
                table: "Matche",
                column: "VenueId");
